...
class TestShowList(SetupList):
    ...
    def test_show_even(self, print_mock):
        ...
        print_mock.assert_has_calls([call('My Shopping List:'), call('\n'),
                                     call('--------------------'), call('\n'),
                                     call('|      Apples      |'), call('\n'),
                                     call('|     Bananas      |'), call('\n'),
                                     call('|Oranges -Purchased|'), call('\n'),
                                     call('|   Watermelons    |'), call('\n'),
                                     call('--------------------\n'),
                                     call('\n')])
...
class TestPurchaseItem(SetupList):
    def setUp(self):
        ...
        self.show_mock = patch.object(ShoppingList, 'show_list').start()
